...
class AppStack extends TerraformStack {
    constructor(scope: Construct, projectName: string) {
        ...
        const containerRegistry = new ContainerRegistryResource(this, PROJECT_ID, projectName, 'api', REGION, credentials.client_email)
            .inject({
                location: 'asia',
            })
            .gen()
        ...
        const apiCloudRunInstance = new CloudRunResource(this, PROJECT_ID, projectName, 'api', REGION, credentials.client_email)
            .inject({
