...
export const createNotificationConverter = (): FirestoreDataConverter<NotificationModel> => new NotificationConverter()

class NotificationConverter implements FirestoreDataConverter<NotificationModel> {
